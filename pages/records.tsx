...
class RecordedStreamPage extends React.Component<PropsFromRedux, RecordPageState> {
    ...
    render(): React.ReactNode {
        const { searchBorderCol, searchState, isLoading } = this.state;
                ...
                <main>
                    <div className="pt-5 pr-5 pb-0 pl-5">
                        <label className="flex flex-row gap-0 group">
                            <span
                                className={`bg-gray-600 border border-r-0 ${searchBorderCol} p-3 items-center`}
                            >
                                <SearchIcon
...
export default connector(RecordedStreamPage);
