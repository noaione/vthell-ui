...
interface ExtraProps {
    ...
    onDoneChange: (payload: AutoScheduler) => void;
}
        ...
        return (
            <>
                ...
                <div className="flex flex-col justify-center w-full mt-2">
                    ...
                    <TypeSelector onChange={(value) => this.onTypeCHange(value)} current={this.state.type} />
                </div>
            </>
        );
    }
...
class AutoSchedulerEditor extends React.Component<ExtraProps, DataState> {
    ...
    onDoneChange(original = false) {
        if (original) {
            this.props.onDoneChange(this.props.scheduler);
            return;
        }
        ...
        this.props.onDoneChange(newBase);
    }
        ...
        return (
            <div className="flex flex-col">
                ...
                {["word", "regex"].includes(type) && (
                    <Buttons className="mt-2" btnType="success" onClick={() => this.addEmptyChain()}>
                        Add Chain
                    </Buttons>
                )}
                <div className="flex flex-row w-full gap-2 mt-2">
                    <Buttons btnType="primary" className="w-full" onClick={() => this.onDoneChange()}>
                        Submit
                    </Buttons>
                    <Buttons btnType="danger" className="w-full" onClick={() => this.onDoneChange(true)}>
                        Cancel
                    </Buttons>
                </div>
            </div>
